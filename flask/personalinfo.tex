...
\newcommand{\Dpositions}{Senior Software Engineer/Created synergy and scaled big data using map reduce. Used Hadoop to increase scalability on the Google+ 10x from 10 users to 100. Developed an in-house SaaS and BaaS solution to facilitate the massive growth./1/2012,QA Engineer/Tested using various testing frameworks such as Selenium and something else. Mainly involved with testing Social Software and Software around IoT for pets. Used Object-Oriented Programming with C to write UI automation software for internal command line tools.
/2/2013,Growth Hacker/Growth hacking at SoundCloud using various social media strategies. Lead the marketing efforts as an interim VP of Marketing. In charge of spreading SoundClound's mission for scale and real-time on the web 2.0.
/9/2009}
